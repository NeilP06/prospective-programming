...
export default function Lesson(props) {
    ...
    if (props.condition === "homepage") {
        ...
        return (
            <div className="h-96 w-80 p-10 mr-16 rounded-lg bg-slate-200 dark:bg-gray-800 border-2 border-white dark:border-gray-600 hover:cursor-pointer hover:translate-x-2 hover:translate-y-2 duration-700">
                ...
                <p className="mt-10 text-md font-bold text-slate-900 dark:text-gray-200">{props.status}</p>
            </div>
        );
    }
}